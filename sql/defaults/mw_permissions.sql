...
('default', 'user', '["move","move-subpages","move-rootuserpages","move-categorypages","movefile","edit","createpage","createtalk","upload","reupload","reupload-shared","minoredit","editmyusercss","editmyuserjson","editmyuserjs","sendemail","applychangetags","changetags","editcontentmodel","user"]', '[]', '[]', '[]', '[]', NULL);
