...
class SpecialManageWikiPermissions extends SpecialPage {
	...
	function buildPermCheckboxes( $group ) {
		global $wgUser, $wgManageWikiPermissionsBlacklistRights, $wgManageWikiPermissionsBlacklistGroups, $wgManageWikiPermissionsBlacklistRightsAnon;
		$editable = ( in_array( $group, $wgManageWikiPermissionsBlacklistGroups ) ) ? false : $wgUser->isAllowed( 'managewiki' );
		...
		$rights = ( $group == "*" ) ? array_diff( User::getAllRights(), array_merge( $wgManageWikiPermissionsBlacklistRights, $wgManageWikiPermissionsBlacklistRightsAnon ) ) : array_diff( User::getAllRights(), $wgManageWikiPermissionsBlacklistRights );
		sort( $rights );
	...
	function doSubmit( $group ) {
		global $wgUser, $wgDBname, $wgManageWikiPermissionsBlacklistGroups, $wgCreateWikiDatabase, $wgManageWikiPermissionsBlacklistRights, $wgManageWikiPermissionsBlacklistRenames, $wgManageWikiPermissionsBlacklistRightsAnon;
		...
		$allRights = ( $group == "*" ) ? array_diff( User::getAllRights(), array_merge( $wgManageWikiPermissionsBlacklistRights, $wgManageWikiPermissionsBlacklistRightsAnon ) ) : array_diff( User::getAllRights(), $wgManageWikiPermissionsBlacklistRights );
