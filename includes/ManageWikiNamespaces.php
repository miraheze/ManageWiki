...
class ManageWikiNamespaces {
	...
	public static function modifyNamespace( bool $id, string $name, int $search, int $subpages, string $protection, int $content, int $core, array $aliases, string $wiki = NULL ) {
